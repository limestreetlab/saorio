...
wallpaper VARCHAR(300) COMMENT 'absolute path',
...
timestamp TIMESTAMP NOT NULL DEFAULT NOW() COMMENT 'epoch timestamp representing post creation time',
edit_timestamp TIMESTAMP DEFAULT NULL COMMENT 'epoch timestamp for post edit time',
