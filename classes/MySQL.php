...
final class MySQL {
  ...
  */
  ...
  public $readFriendshipQuery = "SELECT * FROM friends WHERE user1 = :a AND user2 = :b AND status = 1 UNION select * FROM friends WHERE user1 = :b AND user2 = :a AND status = 1"; //null if a and b are not confirmed friends
