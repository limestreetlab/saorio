...
class NavMenu {
  ...
  private $loggedInMenu = ["Home" => "home", "Profile" => "profile", "Messages" => "messages", "Friends" => "friends", "Members" => "members", "Log Out" => "logout"];
  private $unLoggedInMenu = ["Home" => null, "Log In" => "login", "Sign Up" => "signup"]; 
  private $icons = [null => "bi bi-house", "login" => "bi bi-box-arrow-in-right", "signup" => "bi bi-door-open", "home" => "bi bi-house-door", "members" => "bi bi-list-task", "friends" => "bi bi-people", "messages" => "bi-envelope-open", "profile" => "bi bi-person", "logout" => "bi bi-box-arrow-right"];
  private $html;
